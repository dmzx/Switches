...
var $u_action;
	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			$config->set('switches_name_field_first', utf8_normalize_nfc($request->variable('switches_name_field_first', '', true)));
			$config->set('switches_text_field_first', utf8_normalize_nfc($request->variable('switches_text_field_first', '', true)));
			$config->set('switches_enable_second', $request->variable('switches_enable_second', 0));
			$config->set('switches_name_field_second', utf8_normalize_nfc($request->variable('switches_name_field_second', '', true)));
			$config->set('switches_text_field_second', utf8_normalize_nfc($request->variable('switches_text_field_second', '', true)));
			$config->set('switches_enable_third', $request->variable('switches_enable_third', 0));
			$config->set('switches_name_field_third', utf8_normalize_nfc($request->variable('switches_name_field_third', '', true)));
			$config->set('switches_text_field_third', utf8_normalize_nfc($request->variable('switches_text_field_third', '', true)));
